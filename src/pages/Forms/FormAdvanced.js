                                    ...
                                    <CardBody>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="text-muted m-b-15">
                                                ...
                                                chars or less? Use the <code>threshold</code>{" "}
                                                option:
                                            </p>
                                            <Input
                                                type="text"
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <p className="text-muted m-b-15">
                                                ...
                                                isenabled, the <code>threshold</code> option is
                                                ignored.
                                            </p>
                                            <Input
                                                type="text"
                                            ...
                                            {this.state.disbadge ? (
                                                <span className="badgecount">
                                                    <span className="badge badge-success">
                                                        You Typed {this.state.optioncount} out of 25
                                                        chars available.
                                                    </span>
                                                </span>
                                            ) : null}
