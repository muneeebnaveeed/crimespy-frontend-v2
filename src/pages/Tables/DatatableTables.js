                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="card-title-desc">
                                            mdbreact DataTables has most features enabled by default, so all you need to
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="card-title-desc">
                                            ...
                                            direction. This can generally be seen as an alternative method to pagination
                                            for displaying a large table in a fairly small vertical area, and as such
                            ...
                            <Col xs={12}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <ToolkitProvider keyField="id" data={data1} columns={columns1} columnToggle>
                                            {(props) => (
                                                <div>
                            ...
                            <Col xs={12}>
                                <Card>
                                    <CardBody>
                                        ...
                                        <p className="card-title-desc">
                                            This example shows the multi option. Note how a click on a row will toggle
                                            its selected state without effecting other rows, unlike the os and single
                                            options shown in other examples.
                                        </p>
                                        <BootstrapTable
                                            keyField="id"
                                            data={products}
